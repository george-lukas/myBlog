...
#+BEGIN_QUOTE
Começamos adicionando um método para o construtor *PostNewR*.
O caminho é, /config/routes.
#+END_QUOTE
...
#+BEGIN_QUOTE
Podemos agora remover nosso /data BlogPost/ e implementar nosso construtor, que será salva em um banco de dados.
E nosso Handler fica assim:
#+END_QUOTE
...
#+BEGIN_QUOTE
Agora criaremos uma página que nos permite criar nos blogposts.
...
#+BEGIN_QUOTE
Editaremos agora a página para que possamos salvar as postagens.
#+END_QUOTE
...
#+BEGIN_QUOTE
Em PostNew.hs redirecionaremos quando inserirmos um blogpost, seremos redirecionado para aquela página.
#+END_QUOTE
...
#+BEGIN_QUOTE
Agora indexaremos tudo na página inicial.
Editamos o arquivo routes.
#+END_QUOTE
